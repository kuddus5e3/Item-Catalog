...
# Create dummy user
User1 = User(name="Kuddus Shaik", email="khuddus1412@gmail.com",
             picture='https://www.bing.com/images/search?view=detailV2&id=8F2224446466D8BB6E729A3DD0E958D782A2379C&thid=OIP.XVQhw3zWkizu6LGmEvAmqwHaHa&mediaurl=https%3A%2F%2Fwww.hit4hit.org%2Fimg%2Flogin%2Fuser-icon-6.png&exph=512&expw=512&q=user&selectedindex=18&ajaxhist=0&vt=0&eim=2,6')
session.add(User1)
session.commit()
